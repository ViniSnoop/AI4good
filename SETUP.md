...
|-------|-------------|---------|
| [`SETUP-accounts.md`](SETUP-accounts.md) | Everything needing a credential: web search, Exa, Google, the Telegram bot. | web-search, exa, google-auth, telegram-capture |
