...
1. **Read `SETUP.md` in full.** Its header defines the contract every step follows — `> feature:`,
   **Precondition**, **Install**, **Verify** — and the steps themselves live between the
