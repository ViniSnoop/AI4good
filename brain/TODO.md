...
>
> **scope**: life, academic, and per-project tasks. Workspace-OS build work does **not** live here —
> it lives in [/ROADMAP.md](../ROADMAP.md), the single wos ledger. Done items are deleted, not
> archived: git is the history.
