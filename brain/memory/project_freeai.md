...
**freeai** = mapa das opções gratuitas para codar com IA. Quatro tabelas (harnesses CLI, extensões IDE, provedores com free tier, modelos open-weights) com links oficiais por linha e carimbo de verificação. PT-BR.
...
- Gemas numéricas: Gemini CLI 60 RPM/1K dia; Groq até 14,4K dia modelos pequenos; OpenRouter :free 20 RPM/50 dia (1K dia com ≥US$10 aporte)
