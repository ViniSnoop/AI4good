...
> [ ] [tiny-quant] avaliar quantização extrema como caminho pro setup local — Qwen3.6-27B rebuildado em 1-bit (3.9GB) / ternário (5.9GB), arquitetura intacta, cabe até em celular (ref em `core/refs/REFS-unjudged.md`). Amarra direto em [local-setup]: decide se a RTX 3050 6GB roda um 27B em vez de um 7B (INBOX 2026-07-23)  
> [ ] [tts-local] KittenTTS <25MB em CPU — checar suporte a pt-BR ANTES de qualquer integração; sem pt-BR não serve pra nada aqui (ref em `core/refs/REFS-unjudged.md`, INBOX 2026-07-23)  
