...
2026-08-24 · 2386 tracked files scanned · **802 findings**, 280 of them here
...
| Constraints trapped in a CONTEXT.md head | 6 |
...
| [`code/statem`](code/statem/ISSUES.md) | 30 |
...
- .zcode/skills/compass/SKILL.md — 1 line(s) over the 120-column cap (first at line 3)
- .zcode/skills/craft/SKILL.md — 11 line(s) over the 120-column cap (first at line 17)
- .zcode/skills/dedup/SKILL.md — 1 line(s) over the 120-column cap (first at line 3)
- .zcode/skills/gmail/SKILL.md — 1 line(s) over the 120-column cap (first at line 13)
- .zcode/skills/handoff/SKILL.md — 4 line(s) over the 120-column cap (first at line 3)
- .zcode/skills/inbox/SKILL.md — 8 line(s) over the 120-column cap (first at line 4)
- .zcode/skills/iso-visual/SKILL.md — 13 line(s) over the 120-column cap (first at line 3)
- .zcode/skills/prepare/SKILL.md — 3 line(s) over the 120-column cap (first at line 3)
- .zcode/skills/research/SKILL.md — 2 line(s) over the 120-column cap (first at line 36)
- .zcode/skills/roundup/SKILL.md — 2 line(s) over the 120-column cap (first at line 3)
...
- brain/INBOX.md — 13 line(s) over the 120-column cap (first at line 12)
...
- core/tools/test/law/entropy — 9 code files in one directory, over the WARN_FILES signal; split by responsibility if the split removes more table than the hop adds
...
- .zcode/CONTEXT.md: head is 1001 tok carrying 3 constraint(s).
