...
2026-08-24 · 2363 tracked files scanned · **645 findings** (2026-08-13: 95 · +550 over 11 days), 153 of them here
...
- ROADMAP-legibility.md — 216 lines, over the 200 cap; introduced by 58434ea lsfcin
...
- brain/INBOX.md — 1 line(s) over the 120-column cap (first at line 35)
...
- brain/memory/fable_quota_strategy.md — 1 line(s) over the 120-column cap (first at line 3)
...
- brain/memory/feedback_full_workflow_thinking.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/feedback_plain_language.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/feedback_provider_agnostic_naming.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/feedback_question_context.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/feedback_visual_eyeball_gate.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_aiwbot.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_casinhas.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_dobra.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_freeai.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_hybrid_ideation.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_instituto.md — 1 line(s) over the 120-column cap (first at line 3)
- brain/memory/project_isoroll_scene.md — 1 line(s) over the 120-column cap (first at line 3)
...
- brain/memory/reference_linuz90_bot.md — 1 line(s) over the 120-column cap (first at line 3)
...
- core/ROADMAP.md — 203 lines, over the 200 cap; introduced by 5c22650 lsfcin
- core/agents/researcher.md — 1 line(s) over the 120-column cap (first at line 5)
- core/flows/craft/architect.md — 1 line(s) over the 120-column cap (first at line 2)
- core/flows/craft/craft.md — 1 line(s) over the 120-column cap (first at line 2)
- core/flows/craft/route.md — 1 line(s) over the 120-column cap (first at line 2)
- core/flows/mechanism-search.md — 1 line(s) over the 120-column cap (first at line 2)
- core/flows/research/audit.md — 1 line(s) over the 120-column cap (first at line 2)
- core/flows/research/compare.md — 1 line(s) over the 120-column cap (first at line 2)
...
- core/flows/research/summarize.md — 1 line(s) over the 120-column cap (first at line 2)
...
- core/skills/foundry/coords.md — 1 line(s) over the 120-column cap (first at line 4)
- core/skills/handoff.md — 1 line(s) over the 120-column cap (first at line 3)
- core/skills/inbox.md — 1 line(s) over the 120-column cap (first at line 4)
- core/skills/iso-visual.md — 1 line(s) over the 120-column cap (first at line 3)
- core/skills/prepare.md — 1 line(s) over the 120-column cap (first at line 3)
- core/skills/roundup.md — 1 line(s) over the 120-column cap (first at line 3)
...
- core/tools/test/law/entropy — 11 code files in one directory, over the BLOCK_FILES cap; split by responsibility if the split removes more table than the hop adds
...
- . — feature/entropy-column-drain is 1 ahead of main
...
2026-08-24 · `make verify-full` · **green (519 passed)**
<!-- verify:end -->
