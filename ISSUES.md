...
2026-08-27 · 2368 tracked files scanned · **37 findings here** (2026-08-25: 33 · +4 over 2 days) · 571 more across 26 nested repos, each in its own ISSUES.md
...
| [`branches/casinhas`](branches/casinhas/ISSUES.md) | 12 |
...
- brain/INBOX.md — 5 line(s) over the 120-column cap (first at line 12)
...
- . — feature/wos-lean-specs is 1 ahead of main
...
- . — 4 merged into main: git -C . push origin --delete feature/calendario-tecedu feature/gdocs feature/self-description-grounding feature/wos-lean
...
2026-08-25 · `make verify-full` · **green (552 passed)**
<!-- verify:end -->
