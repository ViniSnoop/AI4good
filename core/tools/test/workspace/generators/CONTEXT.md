...
|------|-----------------------------|
| [`test_routing_table.py`](test_routing_table.py) | Do the generated columns hold what they claim? |
| [`test_routing_sync_bugs.py`](test_routing_sync_bugs.py) | Four ways the routing block has gone wrong before. |
| [`test_interface_generators.py`](test_interface_generators.py) | Does a stub land beside its source — and only there? |
