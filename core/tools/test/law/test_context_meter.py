# T0 context meter (core/SPECS-session.md § AD-09): the session-size signal that decides when to hand off.
...
def test_the_meter_never_spawns_a_session():
    """Decided 2026-08-13 (core/SPECS-session.md § AD-09): a successor cannot take the terminal, so none is spawned."""
