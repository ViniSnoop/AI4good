...
| [`test_context_meter.py`](test_context_meter.py) | [`test_context_meter.pyi`](test_context_meter.pyi) | T0 context meter (core/SPECS-session.md § AD-09): the session-size signal that decides when to hand off. |
