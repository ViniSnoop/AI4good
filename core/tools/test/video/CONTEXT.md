...
|------|-----------|-----|-------------|
| [`test_video_cli.py`](test_video_cli.py) | [`test_video_cli.pyi`](test_video_cli.pyi) | `bundle`, `explode`, `fetch`, `fetch`, `half` | test_video_cli.py — T1 unit tests for the video CLI's batch path (no network, injected runners) |
