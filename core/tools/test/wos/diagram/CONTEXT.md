...
| [`test_diagram_repo.py`](test_diagram_repo.py) | [`test_diagram_repo.pyi`](test_diagram_repo.pyi) | T1 the per-repo picture (ROADMAP-legibility.md, ruled 2026-08-20): every code repo draws itself from the sources it actually has. Zero-token, no network, no browser. |
<!-- routing:end -->
