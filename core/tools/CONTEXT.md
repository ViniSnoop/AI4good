...
| [`verify/`](verify/CONTEXT.md) | Verification contract + patterns for all code projects: tiers T0-T3, script names, dump-oracle rules. Reference implementation: code/isoroll-module/test/. |
