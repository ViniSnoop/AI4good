...
| [`gcli.py`](gcli.py) | [`gcli.pyi`](gcli.pyi) | `fanout`, `auth_command` | gcli.py — the two things every Google-backed CLI does identically: consent, and fan out over accounts |
