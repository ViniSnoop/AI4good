...
| [`lead.md`](lead.md) | Orchestrates research workflows; plans tasks, delegates to worker agents… |
| [`researcher.md`](researcher.md) | Gather primary evidence across papers, web sources, repos, docs, and local… |
| [`reviewer.md`](reviewer.md) | Simulate a tough but constructive AI research peer reviewer with inline… |
