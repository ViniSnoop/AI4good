...
| File | Description |
|------|-------------|
| [`SPECS.md`](SPECS.md) | skills — Specs |
...
| [`inbox.md`](inbox.md) | Triage brain/INBOX.md — route each entry to a goal, task, reference, project doc, writing draft, or delete. Cross-domain front door: reaches into code ROADMAP/BUGS and domain refs/, not just brain/. |
