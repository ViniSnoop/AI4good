...
**If [`core/tools/wos/roundup`](../tools/wos/roundup) ran this session, its three printed lines
...
**Never spawn a successor session.** Decided 2026-08-13 ([`core/SPECS.md`](../SPECS.md) § AD-09): `claude --bg`
