...
|------|-----------|-----|-------------|
| [`brain_attention.py`](brain_attention.py) | [`brain_attention.pyi`](brain_attention.pyi) | `parse_owns`, `governing_repo`, `harvest`, `Attention`, `count` | ← add first-line comment |
