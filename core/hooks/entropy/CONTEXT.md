...
| [`entropy_corpus.py`](entropy_corpus.py) | [`entropy_corpus.pyi`](entropy_corpus.pyi) | `tracked_files`, `nested_repos`, `enforcement_paths`, `wiki_exempt_paths`, `walk` | Which files the Tier 0 checks look at, and which of them are allowed to name what the |
