...
def render(findings: dict, scanned: int, root) -> str:
    ...
    out = [START,
           '## Entropy',
           '',
           '> Generated by `core/hooks/entropy/dashboard/entropy-dashboard.py`. Never edit inside '
           'this block, and never copy a count out of it — a copied number is the drift these '
