...
*Registered but measured **inert** until workspace trust is granted in the ZCode client — ISSUES.md B6, experiment
[`core/experiments/zcode-hook-protocol.md`](../experiments/zcode-hook-protocol.md). No zcode cell below reads ✅ until a
post-trust probe run earns it.
