...
| [`issues-gate.py`](issues-gate.py) | [`issues-gate.pyi`](issues-gate.pyi) | `fixed_ids`, `repo_root`, `has_spec`, `main` | PreToolUse: Edit|Write on ISSUES.md — flipping an issue to FIXED requires a matching |
...
| [`type-gate.py`](type-gate.py) | [`type-gate.pyi`](type-gate.pyi) | `check_name`, `failures_for`, `main` | Tier 0 gate (core/SCHEMA.md § The .md type system): a staged file must be a known .md type or a |
<!-- routing:end -->
