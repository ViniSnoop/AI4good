...
- 🔴 Roughly half the column-cap findings left cannot be wrapped, and the fix is a third exemption.
- 🟡 What the drain hit on the way, all four still true.
